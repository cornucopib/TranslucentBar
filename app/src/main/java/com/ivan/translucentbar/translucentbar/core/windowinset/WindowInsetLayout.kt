 ...
 *
 */
class WindowInsetLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr), IWindowInsetLayout {
    private val mWindowInsetHelper: WindowInsetHelper

    init {
        mWindowInsetHelper = WindowInsetHelper(this, this)
    }
