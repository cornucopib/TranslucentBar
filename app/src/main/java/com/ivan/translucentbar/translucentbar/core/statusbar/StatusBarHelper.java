package com.ivan.translucentbar.translucentbar.core.statusbar;
...
//            }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (DeviceHelper.isTablet(context)
                && sStatusbarHeight > UiUtils.INSTANCE.dip2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > UiUtils.INSTANCE.dip2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
